...
public class SearchQuery extends QueryBase implements BulkProductsQuery {
     ...
     * @param availability {@link query.ApiParameters.Availability }
     */
     ...
     * @param priceChange {@link query.ApiParameters.PriceChange}
     */
     ...
     * @param sortBy - {@link query.ApiParameters.SortBy}
     */
